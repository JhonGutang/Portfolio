export const projectList = [
    ...
    {
      name: "Icon Shoppers",
      subheading: "A Community-Driven Online Marketplace",
      link: 'https://icon-shoppers.vercel.app',
      description:
        "Icon Shoppers is a local e-commerce platform designed to connect buyers and sellers within your community. Discover a wide range of products from trusted local vendors, enjoy a seamless shopping experience, and support businesses in your area. With user-friendly browsing, secure transactions, and convenient order management, Icon Shoppers makes it easy to shop local and find everything you need—all in one place.",
      images: ["/projects/icon-shoppers.png"],
      techStack: [
